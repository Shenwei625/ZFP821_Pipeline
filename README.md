...
- FASTQ files in ./Example_data/ (only test data are included in this repository; the complete datasets are available from GEO)
- Expression matrix files in ./Example_data/
